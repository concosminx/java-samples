package com.nimsoc.demo.test;

import com.nimsoc.demo.DirUtils;
import com.nimsoc.demo.FileGenerator;
...
public class BaseFileTest {
  ...
  protected void generateFiles(Path path, String[]... fileNames) throws Exception {
    for (String[] fileNamesArray : fileNames) {
      for (String fileNm : fileNamesArray) {
        generateFile(path.resolve(fileNm), 10);
      }
    }
  }
}
